...
export default class CartController extends Controller {
  ...
  get subtotal() {  //taking price from itemList array
  ...
  @action
  updateItemCount(item,event){  //event is default arg when passed due to on helper function here we explicitely used 
